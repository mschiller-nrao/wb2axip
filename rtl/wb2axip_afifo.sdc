...
set srcC_ff [get_keepers -no_duplicates {*wr_addr[*]*}]
set srcD_ff [get_keepers -no_duplicates {*rd_addr[*]*}]
...
set_data_delay -from $srcC_ff -to $dstA_ff -get_value_from_clock_period dst_clock_period -value_multiplier 0.8
set_max_skew -from $srcC_ff -to $dstA_ff -get_skew_value_from_clock_period min_clock_period -skew_value_multiplier 0.8

set_data_delay -from $srcD_ff -to $dstB_ff -get_value_from_clock_period dst_clock_period -value_multiplier 0.8
set_max_skew -from $srcD_ff -to $dstB_ff -get_skew_value_from_clock_period min_clock_period -skew_value_multiplier 0.8